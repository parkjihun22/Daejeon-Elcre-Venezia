...
const projectData = [
  { label: "사업명", value: "대전 엘크루 베네치아" },
  { label: "사업위치", value: "전 중구 유천동 337-1번지 일원" },
  { label: "대지면적", value: "7,431.0㎡" },
  { label: "건축면적", value: "3,251,90㎡" },
  { label: "연면적", value: "111,276.5856㎡" },
  { label: "용적률", value: "687.20%" },
  { label: "건축규모", value: "지하 4층, 지상 최고 40층, 2개동" },
  { label: "세대수", value: "301세대 (전용 84A,84B 2가지 Tybe)" },
];
  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>대전 엘크루 베네치아 - 사업안내</title>
        <meta
          name="description"
          content="대전 엘크루 베네치아은 혁신적인 주거 환경을 제공하는 새로운 아파트 단지입니다. 이 페이지에서는 프로젝트의 전체적인 개요와 개발 계획을 상세히 소개합니다. 사업의 목적, 주요 설계 및 특징, 그리고 주변 환경을 포함한 다양한 정보를 통해 입주자들에게 더 나은 선택을 할 수 있도록 돕습니다."
        />
        <meta
          name="keywords"
        ...
        <meta property="og:title" content="대전 엘크루 베네치아 - 사업안내" />
        <meta
        ...
        <meta
          property="og:url"
          content="https://layershop.kr/Brand/intro"
        />
          ...
          {`
		{
			...
			"@type": "WebPage",
			"name": "대전 엘크루 베네치아 - 사업안내",
			"description": "대전 엘크루 베네치아은 혁신적인 주거 환경을 제공하는 새로운 아파트 단지입니다. 이 페이지에서는 프로젝트의 전체적인 개요와 개발 계획을 상세히 소개합니다. 사업의 목적, 주요 설계 및 특징, 그리고 주변 환경을 포함한 다양한 정보를 통해 입주자들에게 더 나은 선택을 할 수 있도록 돕습니다.",
			"url": "https://layershop.kr/Brand/intro"
		}
		`}
        </script>
      </Helmet>
      ...
      <p className={styles.screenReaderOnly}>
        대전 엘크루 베네치아은 혁신적인 주거 환경을 제공하는 새로운 아파트
      ...
      <div className={styles.textBox}>
        ...
        <div>대전 엘크루 베네치아의 새로운 자부심으로 찾아옵니다.</div>
      </div>

      <img
        className={styles.img3}
        src={page1}
        alt="대전 엘크루 베네치아 메인 조감도 -image1"
      />
