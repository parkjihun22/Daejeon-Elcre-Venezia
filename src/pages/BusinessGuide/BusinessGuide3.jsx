  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>대전 엘크루 베네치아 - 계약서류안내</title>
        <meta
          name="description"
        ...
        />
        <link rel="canonical" href="https://layershop.kr/BusinessGuide/documents" />

        {/* Open Graph - 소셜 미디어 공유 최적화 */}
        <meta property="og:title" content="대전 엘크루 베네치아 - 계약서류안내" />
        <meta
        ...
        <script type="application/ld+json">
          {`
						...
						"url": "https://layershop.kr/BusinessGuide/documents"
								}
								`}
        </script>
      </Helmet>
