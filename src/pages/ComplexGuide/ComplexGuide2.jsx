  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://layershop.kr/ComplexGuide/detailintro"
        />

        {/* Open Graph - 소셜 미디어 공유 최적화 */}
        <meta
          property="og:title"
          content="대전 엘크루 베네치아 - 호수배치도"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://layershop.kr/ComplexGuide/detailintro"
        />
        ...
        <script type="application/ld+json">
          {`
			...
			"url": "https://layershop.kr/ComplexGuide/detailintro"
					}
					`}
        </script>
      </Helmet>
