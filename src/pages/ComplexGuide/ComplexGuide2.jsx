  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.screenReaderOnly}>
        호수 배치도 페이지는 각 세대의 동·호수(라인) 위치와 기본 평면 정보를 제공합니다.
        원하는 호수를 빠르게 찾고, 향·조망 및 동선 특성을 비교해 나에게 맞는 타입을 선택해 보세요.
      </p>
