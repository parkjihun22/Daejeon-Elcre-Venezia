...
export default function Customer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("https://formspree.io/f/movdypjp", {
        method: "POST",
...
<Helmet>
        ...
        <title>대전 유천 벽산블루밍 - 관심고객등록</title>
        <meta
          name="description"
        ...
        <meta property="og:title" content="대전 유천 벽산블루밍 - 관심고객등록" />
        <meta
        ...
        <meta name="twitter:title" content="대전 유천 벽산블루밍 - 관심고객등록" />
        <meta
      ...
      <div className={styles.customerWrap}>
        ...
        <div className={styles.customerLeft}>
          <div className={styles.textBlock}>
            <h2 className={styles.projectName}>대전 유천 벽산블루밍</h2>
